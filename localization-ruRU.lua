...
FNP_LOCALE_TEXT.FNP_STRING_AUTHOR_VER = "Автор:Allan версия:7.2.5.20170801";
...
FNP_LOCALE_TEXT.FNP_CHANGED_UITYPE = "Тип ПИ изменем! В следующий раз, когда появится новый монстр, он обновится! Если эффект не является положительным, пожалуйста, ПерезагрузитеПИ";
