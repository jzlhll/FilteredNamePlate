...
FNP_LOCALE_TEXT.FNP_STRING_AUTHOR_VER = "Author:Allan version:7.2.5.20170710 V6";
...
FNP_LOCALE_TEXT.FNP_TEXT_INFO0 = "\124cFF00CD00If the setting does not take effect, you can switch the shortcut key to display and hide healthbar(nameplates). If it still has some flaws, try to reload\124r";
end
